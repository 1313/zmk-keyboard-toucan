...
- **Auto-generated keymap diagram**: see [`keymap-drawer/toucan.svg`](keymap-drawer/toucan.svg). Regenerated by GitHub Actions every time `config/toucan.keymap` changes (via [keymap-drawer](https://github.com/caksoylar/keymap-drawer)).
