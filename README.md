...
- **ZMK main + Zephyr 4.1**: migrated off the v0.3 release. Board name is `xiao_ble//zmk` (Zephyr's renamed `seeeduino_xiao_ble`). All builds use the [`nrf52840-nosd` snippet](https://github.com/zmkfirmware/zmk/pull/2545) to recover ~152 KB of flash (and 96 KB of storage) that the default xiao_ble layout reserves for an unused SoftDevice region.
